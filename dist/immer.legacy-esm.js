...
function updateDraftInParent(parent, draftValue, finalizedValue, originalKey) {
	...
	const locations =
		(_a = parent.draftLocations_.get(draftValue)) != null
			? _a
...
function generatePatchesAndFinalize(state, rootScope) {
	...
	const shouldFinalize =
		...
		(state.type_ === 3 /* Set */ ||
			...
			((_b = (_a = state.assigned_) == null ? void 0 : _a.size) != null
				? _b
				: 0) > 0)
	if (shouldFinalize) {
		...
		target.callbacks_.push(function nestedDraftCleanup() {
			...
			if (get(targetCopy, key, target.type_) === value) {
				if (
					...
					((_a = target.assigned_.get(key)) != null ? _a : false) === true &&
					target.copy_
				) {
					handleValue(
...
function createProxy(rootScope, value, parent, key) {
	...
	const scope =
		(_a = parent == null ? void 0 : parent.scope_) != null
			? _a
			: getCurrentScope()
	scope.drafts_.push(draft)
	state.callbacks_ =
		(_b = parent == null ? void 0 : parent.callbacks_) != null ? _b : []
	state.key_ = key
	if (parent && key !== void 0) {
		...
		state.callbacks_.push(function rootDraftCleanup(rootScope2) {
			var _a2
			;(_a2 = rootScope2.mapSetPlugin_) == null
				? void 0
				: _a2.fixSetContents(state)
...
function enablePatches() {
	...
	function getPath(state, path = []) {
		...
		if ("key_" in state && state.key_ !== void 0) {
			const parentCopy =
				(_a = state.parent_.copy_) != null ? _a : state.parent_.base_
	...
	function generateArrayPatches(state, basePath, patches, inversePatches) {
		...
		for (let i = 0; i < base_.length; i++) {
			...
			const isAssigned =
				allReassigned ||
				(assigned_ == null ? void 0 : assigned_.get(i.toString()))
